...
|--------|-----------------|----------|
| [LOGIC-XXX {Название}](../Логики/LOGIC-XXX_{Название}.md) | {Кнопка / Элемент} | {Краткое описание логики} |
...
**Логика:**
- {Элемент}: [LOGIC-XXX](../Логики/LOGIC-XXX_{Название}.md) — {краткое описание логики}
